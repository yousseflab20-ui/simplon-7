    ...
    return ( <>
        <section id="dashbord">
            ...
            <div style={{display:"flex",padding:"0 50px",alignItems:"center"}}>
                <h2>Dashbord</h2>
                <span style={{marginLeft:"250px"}}><i class="fa-solid fa-magnifying-glass" style={{position: "absolute",top:"34px",left: "620px",color: "#888"}}></i><input type="search" placeholder="Search" style={{ paddingLeft: "70px", width: "100%", height: "30px",borderRadius:"40px",background:"#f6f6f6",border:"1px solid #000000",outline:"none"}}/></span>
            ...
            <div style={{background:"#1E1E47",color:"white",width:"190px",height:"85vh",lineHeight:"40px"}}>
                <ul style={{paddingTop:"30px",marginLeft:"30px",listStyle:"none"}}>
                    <li><i class="fa-solid fa-house" style={{marginRight:"10px"}}></i><a href="Dashbord" style={{textDecoration:"none",color:"white"}}>Dashbord</a></li>
                    <li><i class="fa-solid fa-cart-shopping" style={{marginRight:"10px"}}></i><a href="Prodacte" style={{textDecoration:"none",color:"white"}}>Prodact</a></li>
                    <li><i class="fa-solid fa-bag-shopping" style={{marginRight:"10px"}}></i><a href="" style={{textDecoration:"none",color:"white"}}>Commend</a></li>
                    <li><i class="fa-solid fa-gear" style={{marginRight:"10px"}}></i><a href="" style={{textDecoration:"none",color:"white"}}>Settings</a></li>
                    <li><i class="fa-solid fa-file" style={{marginRight:"10px"}}></i><a href="" style={{textDecoration:"none",color:"white"}}>logs</a></li>
                </ul>
            </div>
